...
<head>
    ...
    <script src="scripts/check2.js" type="text/javascript"></script>
...
<div class="page-container">
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <h3 class="page-title">
                ${trackingNumber}
                <small>23请各夜班同事在每日下班前将（前一天）８：00-８：00（当日））设备运转状况填写完毕</small>
            </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
            <div class="row">
